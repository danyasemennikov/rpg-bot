SKILL_NAMES = {
    ...
    'poison_blade': {'name': '☠️ Poison Blade', 'description': 'Fast setup poison on the target, opening a pressure window.'},
    'envenom': {'name': '🐍 Envenom', 'description': 'Primes your toxins: the next poison application hits much harder.'},
    'venom_storm': {'name': '💀 Venom Storm', 'description': 'Unleashes multiple poison effects at once and shines after setup.'},
    'dagger_ult_a': {'name': '🕷️ Spider Nest', 'description': 'Long-pressure toxin: excels in attrition and punishes already poisoned targets.'},
    'backstab': {'name': '🗡️ Backstab', 'description': 'Guaranteed crit against a disoriented target (stun, freeze, poison, or slow).'},
    'smoke_bomb': {'name': '💨 Smoke Bomb', 'description': 'Short mobility window: +35% evasion for 2 turns.'},
