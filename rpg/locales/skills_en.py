SKILL_NAMES = {
    ...
    'defensive_stance': {'name': '🛡️ Defensive Stance', 'description': 'Reduces incoming damage by 40% for 2 turns.'},
    'sword_rush': {'name': '⚡ Rush', 'description': 'Swift attack. You act first for the next 2 turns.'},
    ...
    'parry': {'name': '🔄 Parry', 'description': "Reflects the next enemy attack back at them."},
    'disarm': {'name': '🤺 Disarm', 'description': "Reduces enemy damage by 40% for 2 turns."},
    'counter': {'name': '⚔️ Counter', 'description': 'Passive: 30% chance to counter-attack when taking damage.'},
