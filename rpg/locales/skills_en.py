SKILL_NAMES = {
    ...
    'defensive_stance': {'name': '🛡️ Defensive Stance', 'description': 'Frontline battle stance. Reduces incoming damage by 40% for 2 turns.'},
    'sword_rush': {'name': '⚡ Rush', 'description': 'Dash into melee. Deals damage and applies Vulnerability (+30% incoming damage for 2 turns).'},
    ...
    'counter': {'name': '⚔️ Counter', 'description': 'Passive: chance to strike back when taking damage. Works best in defensive setups.'},
