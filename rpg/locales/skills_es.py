SKILL_NAMES = {
    ...
    'defensive_stance': {'name': '🛡️ Postura Defensiva', 'description': 'Reduce el daño recibido un 40% durante 2 turnos.'},
    'sword_rush': {'name': '⚡ Embestida', 'description': 'Ataque veloz. Actúas primero los próximos 2 turnos.'},
    ...
    'parry': {'name': '🔄 Parada', 'description': 'Refleja el próximo ataque enemigo de vuelta hacia él.'},
    'disarm': {'name': '🤺 Desarmar', 'description': 'Reduce el daño enemigo un 40% durante 2 turnos.'},
    'counter': {'name': '⚔️ Contraataque', 'description': 'Pasivo: 30% de probabilidad de contraatacar al recibir daño.'},
