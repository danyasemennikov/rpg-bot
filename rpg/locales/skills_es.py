SKILL_NAMES = {
    ...
    'poison_blade': {'name': '☠️ Hoja Venenosa', 'description': 'Veneno rápido de preparación para abrir una ventana de presión.'},
    'envenom': {'name': '🐍 Emponzoñar', 'description': 'Potencia tus toxinas: la siguiente aplicación de veneno golpea mucho más fuerte.'},
    'venom_storm': {'name': '💀 Tormenta de Veneno', 'description': 'Lanza varios venenos a la vez y rinde mejor tras el setup.'},
    'dagger_ult_a': {'name': '🕷️ Nido de Arañas', 'description': 'Toxina de presión prolongada: destaca en desgaste y castiga objetivos ya envenenados.'},
    'backstab': {'name': '🗡️ Apuñalar por la Espalda', 'description': 'Crítico garantizado contra un objetivo desorientado (aturdido, congelado, envenenado o ralentizado).'},
    'smoke_bomb': {'name': '💨 Bomba de Humo', 'description': 'Ventana corta de movilidad: +35% de evasión durante 2 turnos.'},
