SKILL_NAMES = {
    ...
    'defensive_stance': {'name': '🛡️ Postura Defensiva', 'description': 'Postura de primera línea. Reduce el daño recibido un 40% durante 2 turnos.'},
    'sword_rush': {'name': '⚡ Embestida', 'description': 'Te lanzas al cuerpo a cuerpo. Inflige daño y aplica Vulnerabilidad (+30% de daño recibido durante 2 turnos).'},
    ...
    'counter': {'name': '⚔️ Contraataque', 'description': 'Pasivo: probabilidad de responder al recibir daño. Rinde mejor en build defensiva.'},
