...
STRINGS = {
    ...
    'location': {
        ...
        'lower_travel_stale': '⏳ Эта кнопка перехода устарела для вашей текущей локации. Открой /location.',
        'lower_menu_sync_hint': '🧭 Кнопки перехода обновлены для вашей текущей локации.',
