...
STRINGS = {
    ...
    'location': {
        ...
        'quest_contract_row': '{title} — убить: {kills}; цель: {target}; награда: {exp} опыта, {gold} золота, +{hunter_points} репутации{bonus}',
        ...
        'location_active_contract_line': '📌 Контракт: {title} ({progress}/{required}, {status})',
