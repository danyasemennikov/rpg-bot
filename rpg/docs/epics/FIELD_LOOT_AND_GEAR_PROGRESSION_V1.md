...
- Status: Merged delivery record for [PR230](https://github.com/danyasemennikov/rpg-bot/pull/230)
...
[system map](../systems/README.md)

This document records the PR230 delivery and does not claim deployment. PR231 later
preserved the itemization, ownership, settlement, and recovery guarantees while
replacing combat/build authorities and normalizing weapon identity through canonical
families. Those later changes do not rewrite the historical PR230 validation below.
