...
This document records the PR229 delivery. It does not claim deployment. Its original
partial victory-reward boundary remains historically accurate; PR230 later introduced
versioned settlement and recovery for its eligible V1 encounters.
