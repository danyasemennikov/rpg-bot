...
> **Superseded design framework — historical only.** Current merged catalogue and
> implementation navigation: [PR231 report](../../CHARACTER_BUILDS_COMBAT_IDENTITY_V1.md)
> and [systems/README.md](../../systems/README.md).
