...
> **Archived workflow template.** Current lifecycle:
...
### Before editing
[List any specific documentation or files the coding agent must read before making changes, e.g., `rpg/AGENTS.md`, `rpg/docs/foundation/GAME_FOUNDATION.md`, or specific feature specs.]
