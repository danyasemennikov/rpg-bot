...
> **Superseded historical status.** Preserved for its period; it is not current
> authority. Use [PROJECT_STATE_CURRENT.md](../../PROJECT_STATE_CURRENT.md) and
...
- `rpg/docs/foundation/GAME_FOUNDATION.md` — философию игры, баланса, оружия и билдов;
- `rpg/docs/archive/specs/COMBAT_CORE_V1_SPEC.md` — историческую архитектурную спецификацию combat core;
...
3. `AGENTS.md`;
4. `rpg/docs/archive/specs/COMBAT_CORE_V1_SPEC.md`;
5. `rpg/docs/foundation/GAME_FOUNDATION.md`;
6. `CLAUDE.md`.
...
3. `rpg/docs/foundation/GAME_FOUNDATION.md` уже жёстко задаёт модель “оружие → ветки → архетип → билд”, а не “классы при создании персонажа”;
...
- Исторический reading order заменён текущим `rpg/docs/DOCS_INDEX.md`; пути `rpg/docs/foundation/GAME_FOUNDATION.md` и `rpg/docs/archive/specs/COMBAT_CORE_V1_SPEC.md` сохранены для навигации.
