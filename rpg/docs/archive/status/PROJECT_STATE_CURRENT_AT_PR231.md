...
> **Archived snapshot — historical only.** Full original body preserved from `main`
> at `ad5435e577e45e63da2ca57af2296203d88cedd5` before documentation consolidation.
> Current authority: [PROJECT_STATE_CURRENT.md](../../PROJECT_STATE_CURRENT.md).
> Unmodified code-formatted paths in the body describe the original layout; consult
> the [commit-pinned source tree](https://github.com/danyasemennikov/rpg-bot/tree/ad5435e577e45e63da2ca57af2296203d88cedd5/rpg/docs)
> or the current [documentation index](../../DOCS_INDEX.md).
...
- See [shipped scope, migration, acceptance and limits](../../epics/PLAYABLE_ALPHA_VERTICAL_SLICE_V1.md).
