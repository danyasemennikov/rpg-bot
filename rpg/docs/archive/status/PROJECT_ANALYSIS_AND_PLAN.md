...
> **Archived historical analysis.** Its active focus has passed. Current merged facts
> and forward priorities live in [PROJECT_STATE_CURRENT.md](../../PROJECT_STATE_CURRENT.md)
> and [ROADMAP_CURRENT.md](../../ROADMAP_CURRENT.md).
...
- **Active Foundation Docs (historical statement):** `rpg/docs/CLAUDE.md` and current `rpg/docs/foundation/GAME_FOUNDATION.md`; use `rpg/docs/DOCS_INDEX.md` for today's reading order.
...
- **Goal (historical):** Clarify canonical paths to active foundation docs in `rpg/AGENTS.md`; the current game-foundation path is `rpg/docs/foundation/GAME_FOUNDATION.md`.
