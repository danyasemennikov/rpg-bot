...
> **Obsolete historical template.** It contains period-specific claims and must not be
> used to create another status authority. Use
...
## Main context files
- `CLAUDE.md`
- `rpg/docs/foundation/GAME_FOUNDATION.md`
- `AGENTS.md`
