...
- Authority: Design guardrails; exact current behavior belongs to code and the [system map](../README.md)
- Last reconciled: 2026-09-23, against `ad5435e577e45e63da2ca57af2296203d88cedd5`

The body preserves the original pre-rollout design chronology. Later PR229–PR231
runtime capabilities supersede statements that group combat or PvP were wholly future.
