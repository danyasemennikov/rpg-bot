...
Ordinary graph travel is implemented. Teleport activation remains disabled and this
document does not authorize its implementation.
The body preserves the original proposal chronology; “next” statements are historical.

## 1. Назначение документа

Этот документ фиксирует **travel / fast travel / teleport rules** для мира из
[WORLD_SKELETON_V1](../../foundation/WORLD_SKELETON_V1.md),
[WORLD_GRAPH_V1](WORLD_GRAPH_V1.md) и
[WORLD_LOCATION_MAP_V1](WORLD_LOCATION_MAP_V1.md).
...
Мир вне хабов должен оставаться рискованным, а смерть должна возвращать игрока в региональный safe hub. Телепорт не должен превращаться в кнопку мгновенного извлечения добычи из frontier/core world. См. [WORLD_SKELETON_V1](../../foundation/WORLD_SKELETON_V1.md) и [PVP_RULESET_FOUNDATION](../../foundation/PVP_RULESET_FOUNDATION.md).
...
Игрок должен видеть не abstract id, а понятные названия мест. Это хорошо сочетается с уже существующим location/i18n каркасом проекта; текущие владельцы перечислены в [system map](../README.md).
...
- важность реального открытия регионов. Такой подход лучше всего совместим с [PvP foundation](../../foundation/PVP_RULESET_FOUNDATION.md).
...
- PvP-мир станет мягче, чем задуман [foundation](../../foundation/PVP_RULESET_FOUNDATION.md). Это противоречило бы общей risk-логике мира.
...
Это лучший компромисс между удобством и risk-based world design, зафиксированным в [world foundation](../../foundation/WORLD_SKELETON_V1.md).
...
### 12.4. i18n
Все display names и UI strings должны идти через существующий i18n-layer проекта. Это естественно ложится на текущую структуру `locations.py` + `locales/locations_*`; см. текущую навигацию в [system map](../README.md).
...
После [WORLD_LOCATION_MAP_V1](WORLD_LOCATION_MAP_V1.md) и этого документа следующий практический документ уже должен быть почти code-facing:
