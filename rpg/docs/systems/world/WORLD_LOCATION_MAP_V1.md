...
- Authority: World/location design context; historical names and planned flags must be checked against code and the [system map](../README.md)
- Last reconciled: 2026-09-23, against `ad5435e577e45e63da2ca57af2296203d88cedd5`

The body preserves its original design-stage chronology. Verify names, aliases, and
flags against current code; planned teleport-facing metadata does not enable teleport.

## 1. Статус документа

Это **design / technical spec** следующего слоя мира после
[WORLD_SKELETON_V1](../../foundation/WORLD_SKELETON_V1.md),
[WORLD_GRAPH_V1](WORLD_GRAPH_V1.md) и
[TRAVEL_AND_TELEPORT_V1](TRAVEL_AND_TELEPORT_V1.md).

Документ нужен, чтобы:
- зафиксировать **канонический location map** мира на node-level;
- перевести world design в **implementation-facing форму**;
- не переизобретать карту заново при переходе к [WORLD_DATA_MODEL_V1](WORLD_DATA_MODEL_V1.md) и коду;
...
- `dark_forest` → legacy alias of `westwild_n7`
...
| `westwild_n1` | Пшеничные поля | `route_westwild` | `frontier` | `capital_city,westwild_n2` | `herbs,small_game` | `open_ground,roadside` | `route_entry,starter_friendly` | `capital_city` | `false` |  | `true` | `101` |  |
| `westwild_n2` | Луга | `route_westwild` | `frontier` | `westwild_n1,westwild_n3` | `wood,herbs,small_game` | `forest_edge,roadside` | `starter_friendly` | `hub_westwild` | `false` |  | `true` | `102` |  |
| `westwild_n3` | Холмы | `route_westwild` | `frontier` | `westwild_n2,westwild_n4` | `wood,herbs,hides` | `mixed_cover,predators` |  | `hub_westwild` | `false` |  | `true` | `103` |  |
| `westwild_n4` | Лиственная роща | `route_westwild` | `frontier` | `westwild_n3,westwild_n5` | `wood,mushrooms,hides` | `leaf_grove,forest_transition,predators` |  | `hub_westwild` | `false` |  | `true` | `104` |  |
| `westwild_n5` | Перелесок | `route_westwild` | `guarded` | `westwild_n4,westwild_n6,hub_westwild` | `meat,hides,herbs` | `mixed_cover,predators` | `hub_branch,guarded_return` | `hub_westwild` | `false` |  | `true` | `105` |  |
...
| `westwild_n6` | Бор | `route_westwild` | `frontier` | `westwild_n5,westwild_n7,mireveil_n6,sunscar_n6` | `wood,mushrooms,hides` | `deep_forest,predators` | `crosslink_candidate` | `hub_westwild` | `false` |  | `true` | `107` |  |
| `westwild_n7` | Тёмный лес | `route_westwild` | `frontier` | `westwild_n6,westwild_n8` | `wood,mushrooms` | `deep_forest,ambush,mixed_cover` |  | `hub_westwild` | `false` |  | `true` | `108` | `dark_forest` |
...
| `frostspine_n1` | Каменная дорога | `route_frostspine` | `frontier` | `capital_city,frostspine_n2,old_mine_entrance` | `stone,ore` | `rocky,choke_path` | `route_entry` | `capital_city` | `false` |  | `true` | `201` |  |
| `frostspine_n2` | Предгорья | `route_frostspine` | `frontier` | `frostspine_n1,frostspine_n3` | `ore,stone` | `rocky,cliffside` |  | `hub_frostspine` | `false` |  | `true` | `202` |  |
| `frostspine_n3` | Перевал | `route_frostspine` | `frontier` | `frostspine_n2,frostspine_n4` | `ore,stone` | `choke_path,cliffside,cold` |  | `hub_frostspine` | `false` |  | `true` | `203` |  |
| `frostspine_n4` | Склон | `route_frostspine` | `frontier` | `frostspine_n3,frostspine_n5` | `ore,coal,stone` | `cold,cliffside,rocky` |  | `hub_frostspine` | `false` |  | `true` | `204` |  |
| `frostspine_n5` | Каменная гряда | `route_frostspine` | `guarded` | `frostspine_n4,frostspine_n6,hub_frostspine` | `ore,coal,stone` | `cold,rocky,choke_path` | `hub_branch,guarded_return` | `hub_frostspine` | `false` |  | `true` | `205` |  |
...
| `frostspine_n6` | Рудники | `route_frostspine` | `frontier` | `frostspine_n5,frostspine_n7,mireveil_n6,ashen_n3b1` | `ore,coal,crystals` | `rocky,choke_path,confined` | `crosslink_candidate` | `hub_frostspine` | `false` |  | `true` | `207` |  |
...
| `frostspine_n10` | Плато | `route_frostspine` | `frontier` | `frostspine_n9,westwild_n10` | `rare_metal,crystals,stone` | `plateau,cold,exposure,elite_pressure` | `core_war_candidate,world_boss_candidate,apex_edge` | `hub_frostspine` | `false` |  | `true` | `211` |  |
...
8. Teleport-facing metadata, совместимая с [TRAVEL_AND_TELEPORT_V1](TRAVEL_AND_TELEPORT_V1.md).
...
# [WORLD_DATA_MODEL_V1](WORLD_DATA_MODEL_V1.md)
