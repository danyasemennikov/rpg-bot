...
- Authority: Static/dynamic world-model intent; exact implementation belongs to code and the [system map](../README.md)
- Last reconciled: 2026-09-23, against `ad5435e577e45e63da2ca57af2296203d88cedd5`

Teleport fields remain data-model capability, not evidence that teleport is active.
The body preserves its original “next implementation step” language as design history;
the static/dynamic separation is now partly implemented and must be checked in code.

## 1. Статус документа

Это **implementation-facing design / technical spec** следующего слоя после
...
- [WORLD_GRAPH_V1](WORLD_GRAPH_V1.md)
...
10. Этот документ является следующей implementation-facing базой после [WORLD_LOCATION_MAP_V1](WORLD_LOCATION_MAP_V1.md).
