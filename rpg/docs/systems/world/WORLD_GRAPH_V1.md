...
- Authority: Graph rationale; ordinary graph rollout is implemented and mapped in [systems/README.md](../README.md)
- Last reconciled: 2026-09-23, against `ad5435e577e45e63da2ca57af2296203d88cedd5`

The body preserves its original design-stage chronology. References to a “next”
rollout are historical; ordinary canonical graph travel is already implemented.

## 1. Назначение документа

Этот документ переводит [WORLD_SKELETON_V1](../../foundation/WORLD_SKELETON_V1.md) в более прикладной **world graph draft**, пригодный как следующий шаг перед кодом.
