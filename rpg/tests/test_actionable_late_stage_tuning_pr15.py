...
def test_project_state_pr15_header_section_and_no_stale_pr14_header():
    ...
    assert "PR: Balance Instrument V2 Pressure Attribution / Lane Classifier" in header
    assert "Status: simulation/reporting pressure attribution diagnostics" in header
