...
ENVIRONMENTAL_SOURCES: dict[str, tuple[tuple[str, float], ...]] = {
    ...
    'frostspine_n6': (('stone_chunk', .40), ('gem_common', .35), ('frostpine_wood', .55)),
    'ashen_n3c1': (('herb_magic', .35), ('herb_common', .30), ('ancient_bark', .30)),
    'sunscar_n1': (('dry_reagent', .45),),
    'sunscar_n2': (('stone_chunk', .30), ('dry_reagent', .35)),
    'sunscar_n3': (('stone_chunk', .35), ('dry_reagent', .30)),
    ...
    'sunscar_n11': (('stone_chunk', .30), ('sunscar_ore', .30), ('dry_reagent', .30)),
    ...
    'mireveil_n9': (('toxic_herb', .25), ('marsh_mushroom', .35)),
