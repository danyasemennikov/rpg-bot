...
ARCHETYPE_METADATA = {
    "guardian_shield_1h": {"display_name": "Guardian (1H + Shield)", "weapon_profile": "sword_1h", "weapon_type": "melee", "damage_school": "physical", "armor_class": "heavy", "offhand_profile": "shield", "role_tags": ["tank", "frontline", "control"], "strengths": ["block", "survivability", "stability"], "weaknesses": ["lower_burst", "lower_mobility"], "preferred_policy_id": "always_guard_fallback", "preferred_skill_ids": ["shield_bash", "defensive_stance", "parry"], "notes": "Validation archetype for defensive frontline pressure."},
