...
MOBS.update({
    ...
    'mountain_stone_golem': _phase1_mob('mountain_stone_golem', '🗿 Каменный голем', 10, 210, 15, 24, 'construct', 'armored', aggressive=False, exp_reward=110, gold_min=5, gold_max=14),
    ...
    'drowned': _phase1_mob('drowned', '🧟 Утопленник', 10, 138, 20, 30, 'undead', 'drowned', aggressive=True, exp_reward=105, gold_min=5, gold_max=14),
