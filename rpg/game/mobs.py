...
MOBS.update({
    ...
    'mountain_stone_golem': _phase1_mob('mountain_stone_golem', '🗿 Каменный голем', 10, 210, 15, 24, 'construct', 'armored', aggressive=False, exp_reward=60, gold_min=3, gold_max=9),
    ...
    'drowned': _phase1_mob('drowned', '🧟 Утопленник', 10, 138, 20, 30, 'undead', 'drowned', aggressive=True, exp_reward=70, gold_min=3, gold_max=10),
