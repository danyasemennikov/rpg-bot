...
_PHASE1_COMBAT_PRESSURE_TAGS = {
    ...
    'mountain_stone_golem': ('armored','elite_bruiser','mitigation_check'),'troll': ('high_hp','sustained_trade','heavy_trade'),'ice_troll': ('high_hp','heavy_trade'),'troll_chief': ('high_hp','heavy_trade','mitigation_check','route_exam'),
    ...
    'skeleton_guard': ('undead','relic_guardian','poison_bleed_poor_target'),'cursed_knight': ('undead','bruiser','cursed','poison_bleed_poor_target'),'skeleton_priest': ('undead','caster','holy_target','poison_bleed_poor_target'),'temple_guardian': ('construct','relic_guardian','elite_bruiser','armored','holy_target','poison_bleed_poor_target','route_exam'),
