...
_SPECS = [
    ...
    _s("cleave_through", "sword_2h", "A", 3, 20, 4, "F", "physical", "damage", 1.0, description="1.00P each; +.30P for targets starting at or below 50% HP."),
    ...
    _s("savage_chop", "axe_2h", "A", 1, 8, 2, "S", "physical", "damage", 1.20, description="1.20P; while own Rage is active add .35P."),
    _s("blooded_resolve", "axe_2h", "A", 2, 12, 5, "Self", None, "heal", description="Heal 25+2.5×VIT, capped at 25% max HP."),
    _s("frenzy_chain", "axe_2h", "A", 3, 18, 4, "S", "physical", "damage", 1.60, 3, "Total 1.60P; during Rage add .70P and consume Rage on hit."),
    _s("last_roar", "axe_2h", "A", 4, 24, 6, "S", "physical", "damage", 1.90, description="1.90P; at ≤40% HP add .85P; heal 15% actual damage, capped at 12% max HP."),
    _s("bleeding_cut", "axe_2h", "B", 0, 8, 2, "S", "physical", "damage", .85, description=".85P and Bleed .20P for 3 ticks."),
    _s("sunder_armor", "axe_2h", "B", 1, 12, 3, "S", "physical", "damage", .90, description=".90P and fixed 30% physical-defense break for 3 opportunities."),
    _s("brutal_overhead", "axe_2h", "B", 2, 14, 3, "S", "physical", "damage", 1.45, description="1.45P with fixed 25% physical-rating penetration."),
    _s("reopen_wounds", "axe_2h", "B", 3, 16, 3, "S", "physical", "damage", 1.20, description="1.20P; own Bleed adds .45P and refreshes its original 3-tick snapshot."),
    _s("ravage", "axe_2h", "B", 4, 24, 5, "S", "physical", "damage", 1.80, 2, "Total 1.80P; +.40P for own Bleed and +.40P for physical-defense break."),
    ...
    _s("rupture_toxins", "daggers", "A", 4, 22, 5, "S", "poison", 1.20, description="1.20P direct; consume own Poison and deal 80% of its remaining raw ticks."),
    ...
    _s("backstab", "daggers", "B", 3, 16, 3, "S", "physical", "damage", 1.30, description="1.30P; with Opening add .80P and consume it."),
