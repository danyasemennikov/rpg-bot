...
_SPECS = [
    ...
    _s("envenom_blades", "daggers", "A", 0, 6, 3, "Self", None, "setup", description="Next landed dagger action adds one Poison stack of .2875P for 3 ticks."),
    _s("toxic_cut", "daggers", "A", 1, 8, 2, "S", "physical", "damage", 1.035, description="1.035P and one Poison stack of .23P for 3 ticks."),
    _s("crippling_venom", "daggers", "A", 2, 10, 3, "S", "physical", "damage", .70, description=".70P; Slow and Weakness 15% for 2 opportunities."),
    _s("widows_kiss", "daggers", "A", 3, 16, 3, "S", "physical", "damage", 1.3225, description="1.3225P plus .23P per own Poison stack, up to three."),
    _s("rupture_toxins", "daggers", "A", 4, 22, 5, "S", "poison", "damage", 1.38, description="1.38P direct; consume own Poison and deal 92% of its remaining raw ticks."),
    ...
    _s("feint_step", "daggers", "B", 2, 8, 3, "S", "physical", "damage", .5525, description=".5525P; on hit gain +20 accuracy for 2 opportunities and Opening."),
    _s("backstab", "daggers", "B", 3, 16, 3, "S", "physical", "damage", 1.30, description="1.30P; with Opening add .80P and consume it."),
    _s("shadow_chain", "daggers", "B", 4, 24, 5, "S", "physical", "damage", 1.615, 3, "Total 1.615P; Opening adds .80P and +40 evasion for 1 opportunity, then is consumed."),
    # Bow — Sniper / Ranger
