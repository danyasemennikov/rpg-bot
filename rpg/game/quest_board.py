...
HUNT_CONTRACTS: tuple[HuntContract, ...] = (
    HuntContract(
        ...
        reward_exp=70,
        reward_gold=30,
        board_locations=('village', 'capital_city'),
        hunter_points_reward=20,
        target_location_ids=('westwild_n3',),
    ),
    HuntContract(
    ...
    HuntContract(
        ...
        board_locations=('village', 'capital_city'),
        hunter_points_reward=20,
        target_location_ids=('westwild_n4',),
    ),
    HuntContract(
    ...
    HuntContract(
        contract_key='hunt_frostspine_white_wolves',
        title_i18n_key='location.quest_contract_frostspine_white_wolves_title',
        target_mob_id='white_wolf',
        required_kills=4,
        reward_exp=105,
        reward_gold=48,
    ...
    HuntContract(
        ...
        title_i18n_key='location.quest_contract_ashen_zombie_clusters_title',
        target_mob_id='zombie',
        required_kills=4,
        reward_exp=108,
        reward_gold=50,
    ...
    HuntContract(
        ...
        title_i18n_key='location.quest_contract_mireveil_leech_swarms_title',
        target_mob_id='leech',
        required_kills=5,
        reward_exp=102,
        reward_gold=47,
