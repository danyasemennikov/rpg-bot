...
ITEMS = {
    ...
    'wood_common':  {'item_id': 'wood_common',  'name': '🪵 Обычная древесина', 'description': 'Простой материал для ремесла.', 'item_type': 'material', 'weapon_type': None, 'rarity': 'common', 'damage_min': 0, 'damage_max': 0, 'defense': 0, 'weight': 2, 'req_level': 1, 'req_strength': 0, 'req_agility': 0, 'req_intuition': 0, 'req_wisdom': 0, 'buy_price': 0, 'sell_price': 3, 'skills_json': '[]', 'stat_bonus_json': '{}'},
    ...
    'enhance_shard': {'item_id': 'enhance_shard', 'name': '🧩 Осколок заточки', 'description': 'Базовый материал для заточки +1..+5.', 'item_type': 'material', 'weapon_type': None, 'rarity': 'common', 'damage_min': 0, 'damage_max': 0, 'defense': 0, 'weight': 1, 'req_level': 1, 'req_strength': 0, 'req_agility': 0, 'req_intuition': 0, 'req_wisdom': 0, 'buy_price': 0, 'sell_price': 15, 'skills_json': '[]', 'stat_bonus_json': '{}'},
    'enhancement_crystal': {'item_id': 'enhancement_crystal', 'name': '⚙️ Кристалл усиления', 'description': 'Материал заточки +6..+9.', 'item_type': 'material', 'weapon_type': None, 'rarity': 'uncommon', 'damage_min': 0, 'damage_max': 0, 'defense': 0, 'weight': 1, 'req_level': 1, 'req_strength': 0, 'req_agility': 0, 'req_intuition': 0, 'req_wisdom': 0, 'buy_price': 0, 'sell_price': 40, 'skills_json': '[]', 'stat_bonus_json': '{}'},
    'power_essence': {'item_id': 'power_essence', 'name': '✴️ Эссенция мощи', 'description': 'Материал заточки +10..+12.', 'item_type': 'material', 'weapon_type': None, 'rarity': 'rare', 'damage_min': 0, 'damage_max': 0, 'defense': 0, 'weight': 1, 'req_level': 1, 'req_strength': 0, 'req_agility': 0, 'req_intuition': 0, 'req_wisdom': 0, 'buy_price': 0, 'sell_price': 80, 'skills_json': '[]', 'stat_bonus_json': '{}'},
...
ITEM_REWARD_TAGS = {
    ...
    'wood_common': {'reward_family': 'gathering_material', 'material_subtype': 'wood'},
