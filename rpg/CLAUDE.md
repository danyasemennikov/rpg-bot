...
### Готово ✅
- [x] Вся база данных + last_seen
- [x] game/* — все модули
- [x] handlers/* — все handlers с полным i18n
- [x] Локализация: предметы, мобы, локации, скиллы (ru/en/es)
- [x] Агро система мобов
- [x] Сброс статов за 100 💰
- [x] Сброс КД после боя
- [x] Реген по last_seen
- [x] Скилл parry с отражением урона
- [x] Ресурсы: herb_common, herb_magic, wood_dark

### Не написано ❌
- [ ] game/quest_engine.py
- [ ] handlers/quests.py

### Будущее 🔮
- [ ] Магазин
- [ ] Механика добычи ресурсов (gather)
- [ ] Крафт
- [ ] Улучшение оружия (+0..+15)
- [ ] Подземелья и рейды
- [ ] PvP
- [ ] Мировые квесты
